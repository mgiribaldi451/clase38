...
const routes = require('./api/login/routes/routes')
const routeInfo = require('./api/info/routes/route')
const UserModel = require('./api/login/models/usuarios');
const compression = require('compression')
const { validatePass } = require('./api/login/utils/passValidator');
const { createHash } = require('./api/login/utils/hashGenerator')

const passport = require('passport');
const LocalStrategy = require('passport-local').Strategy;
const { TIEMPO_EXPIRACION } = require('./api/login/config/config')
...
app.get('/info',compression(), routeInfo.getInfo);
